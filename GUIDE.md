...
7. [문제가 생기면](#7-문제가-생기면)
8. [다음 기수부터는 더 짧게](#8-다음-기수부터는-더-짧게)
...
2번에서 붙여넣은 문장을 실행하면 제출 기능이 `~/.claude/skills/` 에 함께 설치됩니다.
그래서 **다음에 Claude Code를 새로 실행한 뒤부터는** 긴 문장 없이 이렇게만 말하면 됩니다.
...
> 이번 기수에는 왜 긴 문장을 붙여넣나요?
> 실습 중인 창은 이미 실행된 상태라 새로 설치한 기능을 바로 인식하지 못합니다.
> 그래서 긴 문장으로 **직접 안내서를 읽게** 하는 것이고, 하는 일은 완전히 같습니다.
> 창을 다시 켜고 싶지 않은 분들을 위한 방법입니다.
